...
export function CollectionSection() {
  return (
    <section id="flavours" className="relative overflow-hidden">
      <div className="relative min-h-[48rem] md:min-h-[56rem] lg:min-h-[60rem]">
        <Image
          src="/footer.png"
        ...
        <div className="relative z-10 section-padding mx-auto max-w-7xl pt-12 pb-36 md:pb-44 lg:pb-48">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            {products.map((name) => (
              <div key={name} className="flex flex-col items-center text-center">
                <h3 className="font-heading text-[1.75rem] font-bold text-[#1a1a1a]">
                  {name}
                </h3>
              </div>
            ))}
